...
export function createFinishParts(
  ...
  parts.push({
    ...
    usage: {
      inputTokens: {
        total: state.usage.inputTokens || undefined,
        noCache: undefined,
        cacheRead: state.usage.cachedInputTokens || undefined,
        cacheWrite: state.usage.cachedWriteTokens || undefined,
      },
      outputTokens: {
        total: state.usage.outputTokens || undefined,
        text: undefined,
        reasoning: state.usage.reasoningTokens || undefined,
      },
    },
    finishReason,
    providerMetadata: {
